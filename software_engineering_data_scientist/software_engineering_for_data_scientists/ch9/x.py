i dont see "DB path:", os.path.abspath("data/customers.db")
...
gbm_model.fit(customer_obj.train_features,
...
output["model_prediction"] = gbm_model.\
...
sqliteConnection = sqlite3.\
    connect("data/customers.db")
    
import os
print("DB path:", os.path.abspath("data/customers.db"))
...
cursor.executemany(insert_command,
    output.values)
